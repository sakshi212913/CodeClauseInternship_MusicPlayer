...
img_1 = Image.open('icons8-music-100.png')
...
img_2 = Image.open('icons8-circled-play-100.png')
img_2 = img_2.resize((30,30))
img_2 = ImageTk.PhotoImage(img_2)
play_button = Button(down_frame,width=40,height=40,image=img_2,padx=10,bg=col1,font=('Ivy 10'),command=play_music)
play_button.place(x=56+28,y=35)

img_3 = Image.open('icons8-rewind-100.png')
img_3 = img_3.resize((30,30))
img_3 = ImageTk.PhotoImage(img_3)
prev_button = Button(down_frame,width=40,height=40,image=img_3,padx=10,bg=col1,font=('Ivy 10'),command=previous_music)
prev_button.place(x=10+28,y=35)

img_4 = Image.open('icons8-fast-forward-100.png')
img_4 = img_4.resize((30,30))
img_4 = ImageTk.PhotoImage(img_4)
next_button = Button(down_frame,width=40,height=40,image=img_4,padx=10,bg=col1,font=('Ivy 10'),command=next_music)
next_button.place(x=102+28,y=35)

img_5 = Image.open('icons8-pause-100.png')
img_5 = img_5.resize((30,30))
img_5 = ImageTk.PhotoImage(img_5)
pause_button = Button(down_frame,width=40,height=40,image=img_5,padx=10,bg=col1,font=('Ivy 10'),command=pause_music)
pause_button.place(x=148+28,y=35)

img_6 = Image.open('icons8-resume-button-100.png')
img_6 = img_6.resize((30,30))
img_6 = ImageTk.PhotoImage(img_6)
cont_button = Button(down_frame,width=40,height=40,image=img_6,padx=10,bg=col1,font=('Ivy 10'),command=cont_music)
cont_button.place(x=194+28,y=35)

img_7 = Image.open('icons8-stop-circled-100.png')
img_7 = img_7.resize((30,30))
img_7 = ImageTk.PhotoImage(img_7)
stop_button = Button(down_frame,width=40,height=40,image=img_7,padx=10,bg=col1,font=('Ivy 10'),command=stop_music)
...
os.chdir(r'C:\Users\Sakshi\python\music\musics')
songs =os.listdir()
